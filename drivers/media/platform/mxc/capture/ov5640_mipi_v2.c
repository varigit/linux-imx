...
static inline struct ov5640 *to_state(struct v4l2_subdev *subdev)
{
	return container_of(subdev, struct ov5640, subdev);
}

static inline struct v4l2_subdev *to_sd(struct v4l2_ctrl *ctrl)
{
	return &container_of(ctrl->handler, struct ov5640, ctrls.handler)->subdev;
}
...
static long ov5640_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	struct v4l2_control *ctrl = arg;
        struct ov5640 *sensor = to_state(sd);
	int ret = 0;
